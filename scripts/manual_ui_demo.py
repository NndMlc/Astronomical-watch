...
(Relocated from original test_ui.py)
"""
import sys
import os
...
def test_widget():
    ...
    from ui.widget import create_widget, AstronomicalWidget  # noqa: F401
...
if __name__ == "__main__":
    ...
    if test_type == "widget":
        ...
        print("Usage: python scripts/manual_ui_demo.py [widget|normal|integration]")
        success = False
